...
//   async syncToBlockStart(blockBlobHandle?: string): Promise<void> {
//     const blockState = await this._dataAvail.fetchFullBlockState(
//       blockBlobHandle ??
//         (await this._sequencer.fetchLastBlockStart()).blockStateBlobHandle
//     );
//     await this._finalizedStateProxy.setState(blockState);
//     await this._optimisticStateComputer.setState(blockState);
//   }
...
//           computedState.previousBlockState.roots()
//         )
//       ) {
//         // fetch full state
//         const newState = await this._dataAvail.fetchFullBlockState(
//           blockFinalizedEvent.blockStateBlobHandle
//         );
...
//           blockFinalizedEvent.blockStateRoots
//         )
//       ) {
