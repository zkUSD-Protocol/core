...
export class TransactionProver implements IProver<ProvingJobType.ProveTransaction>{
  readonly supportedJobTypes: ProvingJobType.ProveTransaction[]  = [ProvingJobType.ProveTransaction];
