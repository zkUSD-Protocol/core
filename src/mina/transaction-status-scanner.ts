...
import { TransactionStatusesQueryResponse, mkTransactionStatusesQuery } from './graphql.js';
import { IMinaNetworkInterface } from './mina-network-interface.js';
import { RejectedOnInclusion } from './transaction-status.js';
  ...
  public async awaitTransactionStatus(
    ...
    return new Promise<Inclusion>((resolve, reject) => {
      const timeoutHandle = setTimeout(() => {
        ...
        reject(
          new Error(`Transaction ${transactionHash} not found before awaiting timeout`)
        );
      }, timeout);
